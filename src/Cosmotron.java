...
public class Cosmotron {
	...
	String cosmotronData = System.getenv("COSMOTRONDATA");
	...
	ServletHolder h2 = new ServletHolder(new DefaultServlet());
        ...
        ctx1.addServlet(h2, "/*");
	h1.setInitParameter(CosmotronServlet.COSMOTRONDATA, cosmotronData + "/templates");
	h2.setInitParameter("dirAllowed", "true");
	h2.setInitParameter("resourceBase", "/usr/local/share/cosmotron/content");
	s1.start();
